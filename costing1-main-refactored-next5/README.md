...
3. The project now includes `database/database.sqlite`, so SQLite works out of the box.
4. Run `php artisan serve --host=0.0.0.0 --port=8000`

If you want to use MySQL instead, you can still import the SQL files in `database/`.
